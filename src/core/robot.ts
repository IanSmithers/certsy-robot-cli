import { Bounds, RotationDirection, Transform, Vector2D } from "types/custom-types";
import { getDirectionData, isInBounds, rotateDirection, isValueCardinalDirection } from "helpers/bounds-helper";
